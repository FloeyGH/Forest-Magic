package floey.forestmagic.common.world;
...
public class WorldGenCrystalFlower implements IWorldGenerator {
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
        ...
        for (int i=0; i < tries; i++) {
            ...
            if ((world.isAirBlock(x, y, z) || (world.getBlock(x,y,z) == Blocks.snow)) && ForestMagicObjs.crystalFlower.canBlockStay(world, x, y, z)) {
                if (random.nextInt(50) > 8)
                    continue;

                world.setBlock(x, y, z, ForestMagicObjs.crystalFlower, 0, 0);
            }
        }
    }
}